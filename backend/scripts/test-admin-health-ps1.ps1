# PowerShell script to test admin health endpoint
# Usage: .\test-admin-health-ps1.ps1

$BASE_URL = "http://localhost:3001"

Write-Host "🧪 Testing Admin GDPR Health Endpoint" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "Login as non-admin:" -ForegroundColor Gray
...
Write-Host ""
Write-Host "Rate limit test:" -ForegroundColor Gray
...
Write-Host ""
Write-Host "Note: Tests 2-4 require:" -ForegroundColor Cyan
Write-Host "  1. ENABLE_ADMIN_HEALTH=true set in environment" -ForegroundColor White
Write-Host "  2. Valid admin and non-admin test users" -ForegroundColor White
