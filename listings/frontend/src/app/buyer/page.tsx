...
import { FaSearch, FaHome, FaEnvelope, FaInfoCircle, FaUser, FaCog, FaComments, FaExchangeAlt, FaQuestionCircle, FaFacebook, FaTwitter, FaInstagram, FaLinkedin, FaSignOutAlt, FaUserCircle, FaChevronDown, FaMapMarkerAlt, FaPhone } from 'react-icons/fa';
