...
import { FaUser, FaLock, FaEye, FaEyeSlash, FaHome, FaArrowRight, FaShieldAlt, FaCheckCircle, FaSearch, FaEnvelope, FaInfoCircle, FaQuestionCircle, FaUserCircle, FaChevronDown, FaExchangeAlt, FaCog, FaComments, FaSignOutAlt } from 'react-icons/fa';
...
function BuyerLoginForm() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Συνδεθείτε σε δευτερόλεπτα και αποκτήστε πρόσβαση στο dashboard'
    },
    {
      icon: FaHome,
              ...
              >
                <div>
                  <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    Καλώς ήρθατε στην <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">RealEstate</span>
                  </h1>
                  <p className="text-xl text-gray-600 leading-relaxed">
                    Συνδεθείτε στον λογαριασμό σας για να αποκτήσετε πρόσβαση σε όλες τις λειτουργίες της πλατφόρμας
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <button
                      ...
                      className="w-full flex justify-center py-3 px-4 border border-transparent rounded-xl
                               ...
                               focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 font-medium shadow-lg
                  ...
                  <div className="text-center space-y-4">
                    <p className="text-sm text-gray-600">
                      ...
                      <Link href="/buyer/auth/register" className="font-medium text-blue-600 hover:text-blue-500">
                        Εγγραφείτε εδώ
                      </Link>
                    </p>
                    <Link href="/buyer" className="text-sm text-gray-600 hover:text-blue-600">
