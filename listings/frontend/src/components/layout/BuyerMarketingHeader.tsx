...
export default function BuyerMarketingHeader() {
        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-6">
            <Link href="/buyer" className="flex items-center space-x-3 group">
              ...
              <span
                className={`text-xl font-bold bg-gradient-to-r from-blue-900 to-slate-800 bg-clip-text text-transparent ${
